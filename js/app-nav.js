...
sidebar.innerHTML = `
    <nav>
        ...
        <ul>
            ...
            <li><a href="/app/" class="button button-secondary">Dashboard</a></li>
            <li><a href="/my-events" class="button button-secondary">My Events</a></li>
            <li><a href="/settings" class="button button-secondary">Settings</a></li>
            <li><a href="/help" class="button button-secondary">Help</a></li>
        </ul>
    </nav>
`;
