...
| `POST` | `/api/events/respond` | `event:` | **201** `{ id, editToken }` |
| `PATCH` | `/api/events/respond` | `edit:` | Update response; **403** if edits disabled |
| `DELETE` | `/api/events/respond` | `edit:` | **200** `{ ok: true }` |
| `GET` | `/api/events/view` | `event:` | Results; **403** unless sharing enabled |
| `GET` | `/api/events/view` | `manage:` | Results (organizer) |
